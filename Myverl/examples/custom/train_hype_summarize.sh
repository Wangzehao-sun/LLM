...
# Data paths.
train_path=$WORKER_DIR/LLM/Data/deepmath/deepmath_hard_solonly_instruct_rollout_train.parquet # openr1_seprompt_split_12800.parquet openr1_prompt_rewritten_nothinking_12800_qwen3_4b_token_split_points.parquet
...
REPHRASER_PATH=$MODEL_DIR/${2:-"Qwen3-4B-Instruct"} #Model/Qwen2.5-Math-7B-16k-thinkk
...
EXP_NAME="training_0822_joint_decoding"
...
python -m verl.trainer.main_ppo_new \
    ...
    +data.summarize_prompts_key=summarize_prompt \
    ...
    +joint_decode.teacher_model_path=/home/data/shared/Qwen3-4B-Instruct \
    ...
    +actor_rollout_ref.rollout.sr_use_offline=False \
    +actor_rollout_ref.rollout.sr_logprob_prompt=short \
    +actor_rollout_se.model.path=$MODEL_PATH \
    +actor_rollout_ref.rollout.summarize_replace_select=shortest \
    +actor_rollout_ref.rollout.summarize_loss_on_rollout_prompt=False \
