...
train_path=$HOME/LLM/Train/data_0306/openr1_prompt_rewritten_nothinking.parquet
...
python -m verl.trainer.main_ppo_new \
    ...
    actor_rollout_ref.actor.clip_ratio=1 \
    +actor_rollout_ref.actor.policy_loss.off_policy_masking=False \
    +actor_rollout_ref.actor.policy_loss.off_policy_reshape="else" \
    ...
    +actor_rollout_ref.rollout.se_temperature=0.7 \
