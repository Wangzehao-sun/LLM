...
train_path=$HOME/LLM/Train/data/se_prompt/openr1_set42_woanswer.parquet
...
val_files="['$test1_path', '$test3_path']"
...
python -m verl.trainer.main_ppo_new \
    ...
    +actor_rollout_ref.rollout.prefix_mode=sparse \
    +actor_rollout_ref.rollout.accuracy_threshold=0.25 \
    +actor_rollout_ref.rollout.se_temperature=1 \
