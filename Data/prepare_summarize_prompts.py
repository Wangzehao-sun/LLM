...
DEFAULT_TEMPLATE = (
    "You are an expert mathematician. You are given a [Problem] and a "
    "[Reasoning Draft] — an in-progress derivation for it that stops before "
    "the final answer.\n\n"
    ...
    "[Reasoning Draft]. Never use phrases like \"the draft\", \"as given\", "
    "\"as shown above\", or \"from the previous steps\". The reader must have "
    "no idea that any draft was provided to you.\n"
    ...
    "summary. Justify each step from first principles: instead of \"Using the "
    "formula for X,\" write \"Since the problem requires [reason], we have "
    "[step] ...\". Do not copy the draft verbatim.\n"
