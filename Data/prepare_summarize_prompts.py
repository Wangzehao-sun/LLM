...
DEFAULT_TEMPLATE = (
    ...
    "The final answer must read as a normal standalone solution.\n"
    "2. In the rephrased part, preserve the original mathematical structure and logical flow of the draft as much as possible: " 
    "the same assumptions, definitions, equations, inequalities, intermediate results, and nontrivial steps. " 
    "Also preserve useful verification, reflection, correction, or improvement processes when they help solve the problem. "
    "3. Do not summarize the draft, and do not copy long phrases verbatim. "
    "Do not replace a valid method, skip a nontrivial step, or introduce a new intermediate claim that is not supported by the draft.\n"
    "4. After rephrasing the draft, continue the derivation from that point and solve the remaining part of the problem. "
