...
DEFAULT_TEMPLATE = (
    ...
    "2. In the rephrased part, preserve the same mathematical structure as the draft: "
    "the same assumptions, definitions, equations, inequalities, intermediate results, "
    "and logical order. Do not replace the method, skip a nontrivial step, or introduce "
    "a new intermediate claim that is not already supported by the draft. " 
    "3. Do not merely summarize the draft, and do not copy long phrases verbatim.\n"
